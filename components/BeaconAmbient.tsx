...
/**
 * BeaconAmbient — page-level decorative layer.
 *
 * BeaconMark + cream halo + 4 pulse rings + 6 rising embers + BEACON wordmark
 * + tagline + sparkle divider, pinned fixed to viewport center. Persists across
 * scroll. Opacity 32% so it whispers behind content cards.
 */
