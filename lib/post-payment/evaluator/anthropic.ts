...
function buildSection1(bundle: any): any {
  ...
  return {
    ...
    data_sources_table: [
      ...
      ["Metabase BaseSheet (lean)", "CSV (e9005a5c)", "Entity ID, business name, AE/AM, primary category, lead-source label, predicted_6_month_leads, MRR, contact (phone/email), payment timing"],
      ["Metabase BaseSheet supplement", "CSV (385231ff)", "Per-entity churn_potential_flag, churn_potential_status, open_tickets_30d. Merged onto BaseSheet by entity_id."],
...
function buildReferences(): any {
  return {
    ...
    entries: [
      ...
      { source: "Metabase BaseSheet (lean)", identifier: "card e9005a5c", url: "https://metabase.zoca.ai/public/question/e9005a5c-4b5c-405d-af35-a69063c996e5.csv" },
      { source: "Metabase BaseSheet supplement", identifier: "card 385231ff", url: "https://metabase.zoca.ai/public/question/385231ff-4bc9-4b5d-a300-3b16a0fab7be.csv" },
