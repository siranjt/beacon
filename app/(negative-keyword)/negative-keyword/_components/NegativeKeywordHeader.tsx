...
/**
 * Negative Keyword Beacon — page header.
 *
 * Mirrors MissPaymentHeader's lockup: ZOCA wordmark | divider | flame +
 * "Beacon". Single page surface for now (3 tabs handled internally by
 * Dashboard) — if drill-downs land later, add a NavLink list.
 */
export default function NegativeKeywordHeader() {
  return (
