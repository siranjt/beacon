...
type Tab = "All" | "September" | "August" | "July" | "June" | "May";
const TABS: Tab[] = ["All", "September", "August", "July", "June", "May"];
...
export default function Dashboard() {
  ...
  const tabCounts = useMemo(() => {
    const m: Record<Tab, number> = { All: rows.length, September: 0, August: 0, July: 0, June: 0, May: 0 };
    for (const r of rows) {
      if (r.invoiceMonth === "September") m.September++;
      else if (r.invoiceMonth === "August") m.August++;
      else if (r.invoiceMonth === "July") m.July++;
