...
type Tab = "All" | "August" | "July" | "June" | "May";
const TABS: Tab[] = ["All", "August", "July", "June", "May"];
...
export default function Dashboard() {
  ...
  const tabCounts = useMemo(() => {
    const m: Record<Tab, number> = { All: rows.length, August: 0, July: 0, June: 0, May: 0 };
    for (const r of rows) {
      if (r.invoiceMonth === "August") m.August++;
